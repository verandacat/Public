            ...
            <div id="main">
              ...
              <div id="text1">
                <!-- <p style="font-weight:bold;font-size:1.3em;margin-top:5px;margin-bottom:5px;">重要な4つのポイント！大事なのはどんな乳酸菌サプリを選ぶか</p> -->
                  ...
                  <p class="main_text_01">「お腹を下しがち…」</p>
                  <p class="main_text_02" style="padding-left:10px;"> とお悩みの方へ！</p>
                  <p class="main_text_03"><b>本当に腸内フローラを整えてくれるビフィズス菌サプリBEST5を公開！</b></p>
                  ...
                  <span style="color:red; font-weight: bold;" class="mk">ビフィズス菌はお腹の調子を整えるだけでなく、免疫力を高めて感染防御、
                  発ガン抑制、アレルギー症状の改善（花粉症など）など様々な効果につながるもの！</span><br>
