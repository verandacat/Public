            ...
            <div id="layoutbox">
              <div id="main">
                ...
                <div id="text1">
                  ...
                  <p class="main_text_01">「腸内環境を整えて美肌になりたい」</p>
                  <p class="main_text_02" style="padding-left:10px;"> とお悩みの方へ！</p>

                  <p class="main_text_03"><b>本当にスッキリさせてくれる腸内フローラサプリBEST5を公開！</b></p>
                  </div>
                  ...
                  <div class="point_txt_top">
                    ...
                    <span style="color:red; font-weight: bold;">菌活をする人が今、増えています。</span><br>
                    悪玉菌(でぶ菌)を減らし、善玉菌(やせ菌)を増やすことが、
                    <span style="font-weight: bold;">ダイエットや美容、健康のために大事なのはもはや常識</span>ですよね。<br><br>
                   
                    ただ、<span style="font-weight: bold;">“腸内フローラ”を整えるビフィズス菌や乳酸菌、酪酸菌などの菌は</span>
                    <span style="color:blue; font-weight:bold;">加齢と共に減少</span>していきます。<br><br>
                    食べ物で毎日摂取するという手もありますが、 あまり経済的ではありません･･･。<br>
                   
                    なので、<span style="color:red;font-weight: bold;">サプリメントで毎日お手軽かつ経済的に補う</span>のがおすすめです！
                    <br><br>

                    ですが、サプリメントによって品質はまちまち。
                    <span style="color:blue;font-weight: bold;"> 「乳酸菌が配合されていればなんでも同じ」って 安易に選んで失敗したら意味がないですよね。</span><br><br>
