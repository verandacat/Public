  ...
  <div id="wrapper">
    <div class="inner">
      <span class="img-center">
        <img src="./img/n_img/top_banner_01_f.png" width="100%" />
            ...
            <div id="layoutbox">
              ...
              <div id="text1">
                <!-- <p style="font-weight:bold;font-size:1.3em;margin-top:5px;margin-bottom:5px;">重要な4つのポイント！大事なのはどんな乳酸菌サプリを選ぶか</p> -->
                  ...
                  <p class="main_text_01">「お腹の調子を整えたい！」</p>
                  <p class="main_text_01">「便秘になりがちなのをなんとかしたい」</p>
                  <p class="main_text_01">「すぐお腹を下す」</p>
                  <p class="main_text_02" style="padding-left:10px;"> とお悩みの方へ！</p>
                  <p class="main_text_03"><b>本当に腸内フローラを整えてくれる<br>ビフィズス菌サプリBEST5を公開！</b></p>


                  <div class="point_txt_top">

                  <span style="color:red; font-weight: bold;">
                  最近、様々な雑誌やテレビで注目されている腸内フローラ。</span><br>

                  そんな腸内フローラを整え、お腹の調子を整える事ができると有名な<span style="color:red; font-weight: bold;">『ビフィズス菌』！</span><br>
                  最近はヨーグルトでも摂れると有名です。
                  <span style="color: blue; font-weight: bold;">でも…実はヨーグルトなどで摂ってもあまり意味がないのを知っていましたか？</span><br><br>

                  <b>ビフィズス菌はとても胃酸に弱く、殆どが胃で死滅･･･。<br>
                  しかも、ビフィズス菌は加齢と共に減少してしまうことも研究でわかっています。</b><br><br>

                  <span style="color:red; font-weight: bold;">ビフィズス菌はお腹の調子を整えるだけでなく、免疫力を高めて感染防御、 
                  発ガン抑制、アレルギー症状の改善（花粉症など）など様々な効果につながるもの！
　　　　　　　　　　</span><br>
                  ...
                  <span style="color:red;　font-weight: bold;"> 「乳酸菌が配合されていればなんでも同じ」って安易に選んで失敗したら意味がありません…。</span>
                ...
                <img src="./img/n_img/title_point_01_f.png" width="100%">
              ...
              <div class="img-center">
                <img src="./img/n_img/title_ranking_01_f.png" width="100%">
              </div>
