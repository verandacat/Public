  ...
  <div id="wrapper">
    <div class="inner">
      <span class="img-center">
        <img src="./img/n_img/top_banner_01_g.png" width="100%" />
            ...
            <div id="layoutbox">
              <div id="main">
                ...
                <div class="point_txt_top">
                  ...
                  <p class="main_text_01">「腸内フローラを整えたい」</p>
                  <p class="main_text_01">「効率よく乳酸菌を摂りたい」</p>
                  <p class="main_text_03"><b>本当に腸内フローラを整えてくれる<br>乳酸菌サプリBEST5を公開！</b></p>

                  <span style="color:red; font-weight: bold;">最近、様々な雑誌やテレビで注目されている腸内フローラ。</span><br>
                  そんな<b>腸内フローラを整え、様々な悩みの解決のサポートをしてくれる乳酸菌！</b><br><br>
                  ...
                  <b>乳酸菌は胃酸に弱く、殆どが胃で死滅します。しかも、研究で乳酸菌(善玉菌)は加齢と共に減少･･･。</b><br><br>

                  <span style="color:red; font-weight: bold;"">乳酸菌はお腹の調子を整え、<br>
                  免疫力を高めて感染防御、発ガン抑制、アレルギー症状の改善（花粉症など）など様々な効果が！</span><br><br>

                  しっかりと摂っていきたいものですよね。<br><br>
                  その方法としてオススメしたいのが、<b>サプリでの摂取！</b><br><br>

                  ですが、サプリメントによって品質はまちまち。<br><br>
                  <span style="color:red;font-weight: bold;" > 「乳酸菌が配合されていればなんでも同じ」って安易に選んで失敗したら意味がありません…。</span><br><br>
