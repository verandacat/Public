   ...
   <div class="seachinnerbox">
     <form role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>" >
       ...
       <?php if($_GET['pat'] == "m"||$_GET['pat'] == "d") : ?>
        ...
        <label id="cm2"><input class="checkbox" type="checkbox" name="rules[]" value="即効性がある"><span class="checkbox2"></span></label>

       <?php else : ?>
       <label id="c1"><input class="checkbox" type="checkbox" name="rules[]" value="胃酸で死滅しない"><span class="checkbox1"></span></label>
       <label id="c2"><input class="checkbox" type="checkbox" name="rules[]" value="即効性がある"><span class="checkbox2"></span></label>
       <?php endif; ?>
