      ...
      <tbody>
        ...
        <tr>
          ...
          <th>
            <!-- 
                <p>
                 <a class="link-img" target="_blank" href="https://xn--eckalq1hua9ak9609eoj6a.com/links/kou.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                ...
                <p>
                  <span class="lbg">
                  <a target="_blank" href="https://xn--eckalq1hua9ak9609eoj6a.com/links/kou.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">uka</a>
                  </span>
                </p> -->
        ...
        <tr class="btn" style="height: 50px;">
          ...
          <td>
            <!-- <a target="_blank" href="https://xn--eckalq1hua9ak9609eoj6a.com/links/kou.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
