    ...
    <section id="section-01">
        ...
        <div class="txt-wrap">
            ...
            <p><span class="bold bg-y">失敗しないダイエットサプリの正しい選び方</span>と<br><span
                    class="bold bg-y">厳選したおすすめのダイエットサプリ</span>をご紹介します。
            </p><br>
        ...
        <table class="table-01" cellspacing="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>
                        ...
                        <p>
                            <span class="lbg">
                                <a target="_blank"
                                    href="https://xn--eckalq1hua9ak9609eoj6a.com/links/wild.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">ワイルドマンゴーの力</a>
                            </span>
                        </p>
                    </th>
                ...
                <tr>
                    ...
                    <td>
                        <p>
                            ・まだワイルドマンゴーを試したことがない<br>・機能性表示食品を試したい
                        </p>
                    </td>
