...
<div id="wrapper">
  ...
  <section id="section-01">
    ...
    <div class="title-wrap center">
      ...
      <h1>本当におすすめ！<br>厳選！腸内フローラサプリ<br>人気ランキングベスト７を大公開</span></h1>
  ...
  <section id="section-03">
    ...
    <h1 class="midashi">腸内フローラサプリ選びで<br>失敗しないための５つのポイント</h1>
  ...
  <section id="section-04">
    ...
    <div class="swiper-container">
      <ul class="swiper-wrapper tabs">
        ...
        <li class="tab2 swiper-slide active"><a href="#tab2" onclick="rank_bn.src='./img/n_img/ranking-banner-sp-b.png'">腸内フローラ<br>サプリ</a></li>
