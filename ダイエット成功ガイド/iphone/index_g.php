  ...
  <section id="section-04">
    ...
    <div class="swiper-container">
      <ul class="swiper-wrapper tabs">
        ...
        <li class="tab7 swiper-slide active"><a href="#tab5" onclick="rank_bn.src='./img/n_img/ranking-banner-sp-g.png'">ダイエット<br>スムージー</a></li>
      </ul>
    </div>
  ...
  <section id="section-05">
    ...
    <div class="last-container">
      <div class="last-txt bg-wh border-r">
        ...
        <p>ダイエットスムージランキング第１位の<a target="_blank" href="links/gold.php<?php echo "?" . $query2; ?>" target="_blank">シボヘールGOLDスムージー</a>は 今なら <span class="bold red">初回１９８０円</span>モニター募集中！なんと、 <span class="bold">１日わずか１４０円 </span>で試すことが出来ちゃいます。</p>
