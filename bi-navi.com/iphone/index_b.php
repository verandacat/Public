...
<section id="section-01">
  ...
  <div class="title-wrap center">
    <h1 class="left"><span class="red">「体内環境をサポートしてダイエットを成功させたい！」</span></h1>
    <h1 class="left"><span class="red">「すっきりしてポッコリをなくしたい！」</span></h1>


    <h1 class="right">とお悩みの方へ</span></h1><br>

    <h1>本当におすすめ！<br>厳選！体内フローラサプリ<br>人気ランキングベスト５を大公開</span></h1>
  ...
  <table class="table-01" cellspacing="1">
    ...
    <tbody>
      ...
      <tr>
        ...
        <th>
            <p>
              <a class="link-img" target="_blank" href="https://bi-navi.com/links/eraberu.php<?php echo "?" . $query2; ?>">
                <img src="./img/eraberu.jpg" alt="" />
              </a>
            </p>
            <p>
              <span class="lbg">
                <a target="_blank" href="https://bi-navi.com/links/eraberu.php<?php echo "?" . $query2; ?>">花菜の選べる乳酸菌</a>
              </span>
            </p>
          </th>
        ...
        <!-- <th>
                            <p>
                              <a class="link-img" target="_blank" href="https://bi-navi.com/links/kuro.php<?php echo "?" . $query2; ?>">
                                <img src="./img/kuro.jpg" alt="" />
                              </a>
                            </p>
                            <p>
                              <span class="lbg">
                                <a target="_blank" href="https://bi-navi.com/links/hoko.php<?php echo "?" . $query2; ?>">くろしろ</a>
                              </span>
                            </p>
                          </th> -->
      </tr>
      ...
      <tr>
        ...
        <!-- <td>
          <p>・体内からダイエットを考えたい<br>・体内フローラダイエットに興味がある<br>・毎朝スッキリ、ドッサリしたい</p>
        </td> -->
      ...
      <tr class="btn" style="height: 50px;">
        ...
        <td style="width:28%">
          <a target="_blank" href="https://bi-navi.com/links/eraberu.php<?php echo "?" . $query2; ?>">
            <img src="./img/n_img/btn_site_go_s.png" width="100%">
          </a>
        </td>
...
<section id="section-04">
  ...
  <div class="swiper-container">
    <ul class="swiper-wrapper tabs">
      ...
      <li class="tab2 swiper-slide active"><a href="#tab2" onclick="rank_bn.src='./img/n_img/ranking-banner-sp-b.png'">体内フローラ<br>サプリ</a></li>
