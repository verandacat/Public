...
<section id="section-01">
  ...
  <div class="title-wrap">
    ...
    <h1 class="center">本当におすすめ！<br>厳選！体内フローラサプリ人気ランキングベスト５を大公開</span></h1>
    ...
    <tbody>
      ...
      <tr>
        ...
        <th>
          ...
          <p>
            <a class="link-img" target="_blank" href="https://bi-navi.com/links/bise.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
              <img src="./img/bise.jpg" alt="">
            </a>
          </p>
          <p>
            <span class="lbg">
              <a target="_blank" href="https://bi-navi.com/links/bise.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">ビセラ</a>
            </span>
          </p>
        </th>
        ...
        <th>
          ...
          <p>
            <a class="link-img" target="_blank" href="https://bi-navi.com/links/eraberu.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
              <img src="./img/eraberu.jpg" alt="">
            </a>
          </p>
          <p>
            <span class="lbg">
              <a target="_blank" href="https://bi-navi.com/links/eraberu.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">花菜の選べる乳酸菌</a>
            </span>
          </p>
        </th>
      ...
      <tr class="btn" style="height: 50px;">
        ...
        <td>
          <a target="_blank" href="https://bi-navi.com/links/eraberu.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
            <img src="./img/n_img/btn_site_go_s.png" width="100%">
          </a>
        </td>
